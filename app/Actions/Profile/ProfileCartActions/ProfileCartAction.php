...
{
    public function __construct(private ProfileRepository $profile, private CartService $service){}
    ...
    public function execute(): View
    {
        ...
        return view ('/app-page/profile-page/profile-box/profile-cart', ['user'=>$user, 'head'=>$head]);
    }
