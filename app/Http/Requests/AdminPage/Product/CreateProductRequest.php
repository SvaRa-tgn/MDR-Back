...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image_top' => ['required', 'image', 'mimes:jpg,png,jpeg', 'max:20480'],
            'image' => ['nullable', 'image', 'mimes:jpg,png,jpeg,', 'max:20480'],
            'image1' => ['nullable', 'image', 'mimes:jpg,png,jpeg', 'max:20480'],
            'image2' => ['nullable', 'image', 'mimes:jpg,png,jpeg', 'max:20480'],
            'image3' => ['nullable', 'image', 'mimes:jpg,png,jpeg', 'max:20480'],
