<div class="product-block-foto">
    <ul class="product-block-foto-mini-list">
        @foreach($images as $image)
            @if($image->status === 'top')
                <li class="product-block-foto-mini-item active-product">
                    <img class="main-block-item-img" src="{{$image->link}}" alt="{{$product->category}} купить в Рязани">
                </li>
            @else
                <li class="product-block-foto-mini-item">
                    <img class="main-block-item-img" src="{{$image->link}}" alt="{{$product->category}} купить в Рязани">
                </li>
            @endif
        @endforeach
    ...
    <div class="wrap-product-block-foto">
        <ul class="product-block-foto-list">
            @foreach($images as $image)
                ...
                @else
                    <li class="product-block-foto-item">
                        <img class="main-block-item-img" src="{{$image->link}}" alt="{{$product->category}} купить в Рязани">
                        <div class="filter">
                            <div class="wrap-filter-box">
                                <article class="filter-box">
            ...
            <div class="filter-product">
                <div class="wrap-filter-fa">
                    <article class="filter-fa">
                        <div class="button-heart"><i class="fa fa-heart-o fa-3x fa-heart-p " aria-hidden="true" ></i></div>
                    </article>
                </div>
                <div class="wrap-filter-fa">
